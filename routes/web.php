...
Route::middleware(['auth', 'tenant'])->group(function () {
    ...
    // Repairs
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':repairs.view')->group(function () {
    ...
    // Products
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':products.view')->group(function () {
    ...
    // Customers
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':customers.view')->group(function () {
    ...
    // Sales / POS
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':sales.view')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':stock.view')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\CheckPermission::class . ':finance.view')->group(function () {
